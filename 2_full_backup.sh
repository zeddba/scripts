...
#############################################################################
#
# Shell script to take full backup
#
...
echo -e "------------------------"
echo -e "Step 2: Take Full Backup"
echo -e "------------------------"

echo -e "\nContent of 2_full_backup.cmd file:\n"
more /media/sf_Software/scripts/demo/2_full_backup.cmd

echo -e "\nPress Enter to continue"
read var_continue

echo -e "Calling 'rman target / cmdfile=/media/sf_Software/scripts/demo/2_full_backup.cmd'"
$ORACLE_HOME/bin/rman target / cmdfile=/media/sf_Software/scripts/demo/2_full_backup.cmd
...
insert into demo_log values (sysdate, 'Full Backup');
commit;
